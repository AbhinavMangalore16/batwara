    ...
    return (
        <Form {...form}>
            <form className={isMobile ? "flex flex-col items-center text-center w-full" : "p-6"} onSubmit={form.handleSubmit(onSubmit)}>
                <h2 className={isMobile ? "text-2xl font-bold text-center mb-4 text-[#E2E8F0]" : "text-2xl font-bold mb-6 text-center text-[#E2E8F0]"}>Sign In</h2>
                <div className={isMobile ? "flex flex-col gap-4 w-full mb-2" : "flex flex-col gap-4 w-full mb-6"}>
                    ...
                    <FormField control={form.control} name="password" render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="password" placeholder="********" className="w-full border-gray-300 shadow-sm" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                </div>
                <Button disabled={pending} type="submit" className="w-full px-4 mb-4 bg-blue-600 hover:bg-blue-700 text-white">Sign In</Button>
                ...
                <div className={isMobile ? "flex flex-row gap-2 w-full mb-4" : "flex flex-row gap-2 w-full mb-4"}>
                    ...
                    <Button disabled={socialDisabled} variant="outline" className="flex-1 flex items-center justify-center gap-2 py-2 hover:bg-gray-100 border-gray-300 shadow-sm text-black hover:text-black" onClick={socialHandlers?.github}><FaGithub /></Button>
                ...
                <div className="text-center">
                    <Button variant="link" onClick={onSwitch} className="text-blue-600 hover:text-blue-800" type="button">Don&apos;t have an account? Sign Up</Button>
                </div>
                {!!error && (
...
function SignUpForm({ form, pending, error, onSubmit, onSwitch, socialDisabled, socialHandlers, isMobile }: SignFormProps<z.infer<typeof signUpZodSchema>>) {
    return (
        <Form {...form}>
            <form className={isMobile ? "flex flex-col items-center text-center w-full" : "p-6"} onSubmit={form.handleSubmit(onSubmit)}>
                <h2 className={isMobile ? "text-2xl font-bold text-center mb-4 text-[#E2E8F0]" : "text-2xl font-bold mb-6 text-center text-[#E2E8F0]"}>Create Account</h2>
                <div className={isMobile ? "flex flex-col gap-4 w-full mb-2" : "flex flex-col gap-4 w-full mb-6"}>
                    <FormField control={form.control} name="name" render={({ field }) => (
                        <FormItem>
                            <FormLabel>Full Name</FormLabel>
                            <FormControl>
                                <Input type="text" placeholder="Full Name" className="w-full border-gray-300 shadow-sm" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                    <FormField control={form.control} name="email" render={({ field }) => (
                        <FormItem>
                            <FormLabel>Email</FormLabel>
                            <FormControl>
                                <Input type="email" placeholder="lorem@ipsum.com" className="w-full border-gray-300 shadow-sm" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                    <FormField control={form.control} name="password" render={({ field }) => (
                        <FormItem>
                            <FormLabel>Password</FormLabel>
                            <FormControl>
                                <PasswordInput placeholder="********" className="border-gray-300 shadow-sm" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )} />
                ...
                <div className={isMobile ? "flex flex-row gap-2 w-full mb-4" : "flex flex-row gap-2 w-full mb-4"}>
                    ...
                    {/* <Button disabled={socialDisabled} variant="outline" className="flex-1 flex items-center justify-center gap-2 py-2" onClick={socialHandlers?.microsoft}><FaMicrosoft /></Button> */}
                    <Button disabled={socialDisabled} variant="outline" className="flex-1 flex items-center justify-center gap-2 py-2 hover:bg-gray-100" onClick={socialHandlers?.github}><FaGithub /></Button>
                    {/* <Button disabled={socialDisabled} variant="outline" className="flex-1 flex items-center justify-center gap-2 py-2" onClick={socialHandlers?.apple}><FaApple /></Button> */}
                </div>
                <div className="text-center">
                    <Button variant="link" onClick={onSwitch} className="text-blue-600 hover:text-blue-800" type="button">Already have an account? Sign In</Button>
                </div>
                {!!error && (
                    <Alert className="bg-destructive/20 border-accent m-2">
                        <TriangleAlertIcon className="!text-destructive!" />
...
export default function AuthView() {
    ...
    //     });
    // };
    //TODO add social handlers
    // const handleSignOut = () => authClient.signOut();

    // if (session) {
    //     return (
    //         <div className="flex items-center justify-center bg-linear-to-r from-[#e2e2e2] to-[#c9d6ff] font-sans">
    ...
    return (
        <div>
            <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-linear-to-b from-[#0D1117] to-[#02040A] font-sans px-4 text-[#E2E8F0]">
                ...
                <div className="hidden md:flex flex-col items-center text-[#E2E8F0]">
                    {/* Desktop Layout */}
                    <div className={clsx("relative w-[900px] min-h-[600px] bg-[#161B22] rounded-[30px] shadow-xl overflow-hidden transition-all duration-700 hidden md:block", {
                        "active": isSigningUp
                    })}>
                        {/* Sign In Form */}
          ...
          /> */}
                            <Form {...signInForm}>
                                <form className="p-6 w-full" onSubmit={signInForm.handleSubmit(handleSignIn)}>
                                    <div className="flex flex-col items-center text-center w-full">
                                        <div className="flex flex-col items-center text-center w-full">
                                            <h2 className="text-2xl font-bold text-[#E2E8F0]">Welcome Back!</h2>
                                            <h2 className="text-[#94A3B8] text-balance mb-6">Please login to your account</h2>
                                        </div>
                                        <div className="grid gap-3 w-full">
                                                    ...
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input
                                                                ...
                                                                className="w-full bg-[#0D1117] border-[#30363D] text-[#E2E8F0]"
                                                                {...field}
                                                            />
                                                        </FormControl>
                                                        <FormMessage />
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormLabel className="text-[#94A3B8]">Password</FormLabel>
                                                        <FormControl>
                                                            <PasswordInput placeholder="********" className="bg-[#0D1117] border-[#30363D] text-[#E2E8F0]" {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                        ...
                                        <div className="flex items-center my-3 w-full">
                                            <div className="grow h-px bg-muted-foreground/20" />
                                            <span className="mx-4 text-muted-foreground text-xs">Or continue with</span>
                                            <div className="grow h-px bg-muted-foreground/20" />
                                        </div>
                                        <div className="grid grid-cols-2 gap-3">
                                            <Button variant={"outline"} type="button" className="w-full hover:bg-white/5 border-white/10 shadow-sm text-white hover:text-white" onClick={() => { }}>
                                                <FcGoogle /> Google
                                            </Button>
                                            <Button variant={"outline"} type="button" className="w-full hover:bg-white/5 border-white/10 shadow-sm text-white hover:text_white" onClick={() => { }}>
                                                <FaGithub /> GitHub
                                            </Button>
                        ...
                        <div className={clsx("absolute top-0 h-full w-1/2 p-12 transition-all duration-700 ease-in-out", {
                            ...
                            <Form {...signUpForm}>
                                <form className="p-6 w-full" onSubmit={signUpForm.handleSubmit(handleSignUp)}>
                                    <div className="flex flex-col items-center text-center w-full">
                                        <div className="flex flex-col items-center text-center w-full">
                                            <h2 className="text-2xl font-bold text-[#E2E8F0]">Create your account</h2>
                                            <h2 className="text-[#94A3B8] text-balance mb-6">Join us and get started. It's free!</h2>
                                        </div>
                                        <div className="grid gap-3 w-full">
                                            <FormField
                                                    ...
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input
                                                                ...
                                                                className="w-full bg-[#0D1117] border-[#30363D] text-[#E2E8F0] shadow-sm"
                                                                {...field}
                                                            />
                                                        </FormControl>
                                                        <FormMessage />
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        <FormLabel className="text-[#94A3B8]">Confirm Password</FormLabel>
                                                        <FormControl>
                                                            <PasswordInput placeholder="********" className="bg-[#0D1117] border-[#30363D] text-[#E2E8F0]" {...field} />
                                                        </FormControl>
                                                        <FormMessage />
                        ...
                        <div className={clsx(
                            ...
                            <div className="bg-cover bg-center text-[#E2E8F0] flex flex-col justify-end items-center h-full px-10 text-center transition-all duration-700 pb-16"
                                style={{ backgroundImage: "url('/EdClarity-ai.png')" }}>
                                {/* <h2 className="text-3xl font-bold mb-2">
              {isSigningUp ? "Welcome Back!" : "New here?"}
            </h2> */}
                                <p className="text-sm mb-4 animate-fade-slide">
                                    {isSigningUp ? "Already have an account? Sign in now." : "Create your Batwara account in seconds."}
                                </p>
                                <Button
                                    variant="outline"
                    ...
                    <div className="text-foreground *:[a]:hover:text-primary text-center text-xs text-balance mt-8">
